...
enum HYPERCALL_ID {
    ...
    HYPERCALL_PANIC,
    HYPERCALL_START_TRACE,
    HYPERCALL_STOP_TRACE,
    HYPERCALL_START_TIMER,

    // Requests intended for the driver
    DRIVER_REQUEST_REPORT_LOCATIONS,
    DRIVER_REQUEST_REGISTER_HOOK,
    DRIVER_REQUEST_UNREGISTER_HOOK,
    DRIVER_SHOW_ALL_HOOKS,
    HYPERCALL_REQUEST_TEST_CASE,
    HYPERCALL_COMPLETE_TEST_CASE
};
